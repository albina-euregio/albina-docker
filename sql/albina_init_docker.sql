...
VALUES ('/albina/api/', 0, '/usr/local/tomcat/webapps/static/simple', '/opt/avalanche-warning-maps', '/usr/local/tomcat/webapps/static/bulletins', '/usr/local/tomcat/webapps/static/media_files', 'albina.local', '', '/usr/local/tomcat/webapps/static/bulletins', 1, 1, 'https://admin.avalanche.report/images/', 'info@albina.local');
